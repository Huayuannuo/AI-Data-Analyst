...
from router import document_router, search_router, chat_router, research_router, ai_data_analyst_router, feishu_router
...
app.include_router(ai_data_analyst_router)
