...
async def process_document(document_id: str, file_path: str, kb_name: str, db_session_factory):
    ...
    from service.milvus_service import make_kb_collection_name
    ...
    try:
        ...
        try:
            # 使用知识库名称作为ES索引名
            index_name = make_kb_collection_name(kb_name)
...
async def get_document_chunks(
    ...
    """获取文档的所有切片"""
    from service.milvus_service import get_milvus_service, make_kb_collection_name
    ...
    # 从 Milvus 获取切片
    collection_name = make_kb_collection_name(kb.name)
